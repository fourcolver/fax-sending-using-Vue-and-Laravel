...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}],\"syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/views/client.vue":
	...
	data: function data() {
		return {
			...
			telephoneRules: [function (v) {
				return (/(^$)|^([0-9]{10}$)/.test(v) || 'Voer een telefoonnummer in met tien cijfers.'
				);
			}],
			banknumberRules: [function (v) {
				return !!v || 'Dit is een verplicht veld.';
			}, function (v) {
				return (/^([a-zA-Z]{2}[0-9]{2}[a-zA-Z]{4}[0-9]{10}$)/.test(v) || 'Voer een geldig bankrekeningnummer in.'
				);
			}],
			...
			emailRules: [function (v) {
				...
				return (/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(v) || 'Vul hier een geldig emailadres in.'
				);
			}]
		};
	},
			...
			if (this.$refs.form.validate()) {
				...
				axios.post('/api/fax/client/save', clientForm).then(function (response) {
					if (response.data.result === "success") {
						...
						localStorage.setItem('bank_number', _this2.clientForm.banknumber);
						_this2.$router.push({
							name: 'sign'
						});
					}
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-fd3e17ec\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/views/client.vue":
...
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-fd3e17ec\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/views/client.vue")
/* template functional */
